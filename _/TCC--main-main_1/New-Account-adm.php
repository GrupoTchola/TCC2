...
$sql = "SELECT Nome, Sobrenome, email, Senha, Celular, Data_nascimento, CPF"
...
<head>
    ...
    <title>Cadastro Admin | BoaForma</title>
...
<body>
    <header class="header">
        ...
        <a href="Home.html" class="logo"> <span>Boa</span>Forma </a>
                ...
                <div class="form-box">
                    ...
                    <div class="info2">
                        <div class="input-box4">
                            <input id="Celular" type="text" placeholder="Celular" name="Celular">
                        </div>
                        <div class="input-box4">
                            <input id="Data_nascimento" type="date" placeholder="Data de nascimento" name="Data_nascimento">
                        </div>
                    </div>
