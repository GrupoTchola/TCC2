...
<head>
    ...
    <title>BoaForma | Cadastro exercício - Exercício Costas</title>
    <link rel="stylesheet" href="style-form.css">

</head>
<body>
    <h1>Continuação cadastro - Costas</h1>
    ...
    <?php while ($sql = $stmt->fetch(PDO::FETCH_ASSOC)) : ?>
        <label for="exercID">Escolha o exercício:</label>
            <select name="exercID" required>
                ...
                <option value="22">1ㅤ|ㅤPull Down</option>
                <option value="23">2ㅤ|ㅤRemada Cavalinho</option>
                <option value="24">3ㅤ|ㅤRemada sentada</option>
                <option value="25">4ㅤ|ㅤRemada unilateral</option>
                <option value="26">5ㅤ|ㅤPulley frente</option>
            </select>
        <hr>
