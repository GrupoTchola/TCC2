...
<head>
    ...
    <title>BoaForma | Cadastro exercício - Exercício Bíceps</title>
    <link rel="stylesheet" href="style-form.css">

</head>
<body>
    <h1>Continuação cadastro - Bíceps</h1>
    ...
    <?php while ($sql = $stmt->fetch(PDO::FETCH_ASSOC)) : ?>
        <label for="exercID">Escolha o exercício:</label>
            <select name="exercID" required>
                ...
                <option value="27">1ㅤ|ㅤRosca Scott</option>
                <option value="28">2ㅤ|ㅤRosca direta</option>
                <option value="29">3ㅤ|ㅤRosca martelo</option>
                <option value="30">4ㅤ|ㅤRosca direta na polia</option>
            </select>
        <hr>
