...
<head>
    ...
    <title>BoaForma | Cadastro exercício - Exercício Abdômen</title>
    <link rel="stylesheet" href="style-form.css">

</head>
<body>
    <h1>Continuação cadastro - Antebraço</h1>
    ...
    <?php while ($sql = $stmt->fetch(PDO::FETCH_ASSOC)) : ?>
        <label for="exercID">Escolha o exercício:</label>
            <select name="exercID" required>
                ...
                <option value="31">1ㅤ|ㅤRosca punho</option>
                <option value="32">2ㅤ|ㅤCarregamento de Halteres</option>
                <option value="33">3ㅤ|ㅤSuspensão na barra</option>
                <option value="34">4ㅤ|ㅤRosca de Punho Invertida</option>
            </select>
        <hr>
