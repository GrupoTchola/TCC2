...
<head>
    ...
    <title>BoaForma | Cadastro exercício - Exercício Ombro</title>
    <link rel="stylesheet" href="style-form.css">

</head>
<body>
    <h1>Continuação cadastro - Ombro</h1>
    ...
    <?php while ($sql = $stmt->fetch(PDO::FETCH_ASSOC)) : ?>
        <label for="exercID">Escolha o exercício:</label>
            <select name="exercID" required>
                ...
                <option value="14">1ㅤ|ㅤElevação Lateral</option>
                <option value="15">2ㅤ|ㅤDesenvolvimento de ombros com barra</option>
                <option value="16">3ㅤ|ㅤCrucifixo invertido com halteres</option>
                <option value="17">4ㅤ|ㅤDesenvolvimento Arnold para Ombros</option>
            </select>
        <hr>
