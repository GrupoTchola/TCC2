...
<head>
    ...
    <title>BoaForma | Cadastro exercício - Exercício Panturrilha</title>
    <link rel="stylesheet" href="style-form.css">

</head>
<body>
    <h1>Continuação cadastro - Panturrilha</h1>
    ...
    <?php while ($sql = $stmt->fetch(PDO::FETCH_ASSOC)) : ?>
        <label for="exercID">Escolha o exercício:</label>
            <select name="exercID" required>
                ...
                <option value="39">1ㅤ|ㅤBanco Panturrilha</option>
                <option value="40">2ㅤ|ㅤPanturrilha em pé</option>
            </select>
        <hr>
